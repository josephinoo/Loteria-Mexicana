...
/**
 * Clase Representativa de los atributos del Ganador, junto con su generador de contenido o ventana
 * @author Grupo10
 *
 */
public class Ganador   {
    ...
    public Ganador (menu ventanaMenu){
    ...
    private void createContent() {
        ...
        try (InputStream is = Files.newInputStream(Paths.get("src/resources/3046992.jpg"))) {
        ...
        Title title = new Title(login.nombreJugador);
        title.setTranslateX(305);
        title.setTranslateY(250);

        try (InputStream is = Files.newInputStream(Paths.get("src/resources/youwin.png"))) {
            ImageView img = new ImageView(new Image(is));
            img.setFitWidth(330);
            img.setFitHeight(500);
            img.setTranslateX(270);
            img.setTranslateY(60);
            root.getChildren().add(img);
